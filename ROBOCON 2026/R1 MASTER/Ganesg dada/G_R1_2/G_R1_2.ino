...
float c_kp_base = 5.5f;
float c_ki_base = 0.013f;
    ...
    if (ps5.isConnected()) {
      ...
      if (start % 2 == 1) {
        ...
        if (mode % 2 == 0) {
          ...
          else if (ps5.Circle())       espSerial.println("stp");
          else if (ps5.Square())         espSerial.println("sts");
          ...
          ps5.Touchpad()    ? espSerial.println("S1") : espSerial.println("s1");
